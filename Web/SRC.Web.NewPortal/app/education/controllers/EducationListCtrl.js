...
appMain.controller('EducationListCtrl', ['$scope', '$sce', '$http', '$routeParams', 'safeApply', 'alertModal', 'commonFunc', 'educationFactory', function ($scope, $sce, $http, $routeParams, safeApply, alertModal, commonFunc, educationFactory) {
